...
Page({
  ...
  toggleLang() {
    let _self = this
    tool.showModal(_self.data.languageCon.my.alert[0], _self.data.languageCon.my.alert[1], _self.data.languageCon.my.alert[2] + ',#004c9a', _self.data.languageCon.my.alert[3] + ',#aaa').then(res => {
      if (res) {
